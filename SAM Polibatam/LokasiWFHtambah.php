...
if($lat != null && $lng != null){
	$query="INSERT INTO tbl_pengajuan_alamat SET id='$id', nim_nik_unit='$nim_nik_unit', tanggal_pengajuan='$date', alamat='Politeknik Negeri Batam', isAccepted='0', latitude='$lat', longitude='$lng'";
